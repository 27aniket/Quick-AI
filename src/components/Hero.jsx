...
const Hero = () => {
  ...
  return (
    ...
    <div className='px-4 relative inline-flex
                    flex-col w-full sm:px-20 xl:px-32  justify-center
        ...
        <div className='text-center mb-6'>
            ...
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-lg m-auto max-sm:text
         ...
         <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
              ...
              <button className='bg-white px-10 py-3 rounded-lg border border-gray-300
                                 hover:scale-102 active:scale-95 transition 
