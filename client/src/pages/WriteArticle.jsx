...
const WriteArticle = () => {
  ...
  const [selectedLength, setSelectedLength] = useState(ariticleLength[0])
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-warp gap-4 text-slate-700'>
      ...
      <div className='width-full max-w-lg p-4 rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px] bg-white'>
