...
import {  Hash, House, Image, SquarePen, Scissors, FileText, EraserIcon, User, LogOut } from 'lucide-react';
...
const SideBar = ({sideBar , setSideBar}) => {
  ...
  return (
    <div className= {`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute
                     ...
                     'max-sm:-transalte-x-full'} transition-all duration-300 ease-in-out`}>
                        ...
                        <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center'>
                            ...
                            <div className='flex gap-3 items-center cursor-pointer' onClick={OpenUserProfile}>
                                ...
                                <div>
                                    <LogOut onClick={signOut} className='w-4.5  text-gray-400 hover:bg-gray-700 transition cursor-pointer'/>
                                </div>
